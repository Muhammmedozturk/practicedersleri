...
Scanner input=new Scanner(System.in);
        System.out.println("denklemin a, b ve c sauılarını giriniz:");
        int a =input.nextInt();
        int b =input.nextInt();
        int c =input.nextInt();
        int delta=b*b-4*a*c;
        if (delta>0){
            ...
            System.out.println("denklemn iki kökü vardır : x = "+x1 +" "+x2);
        } else if (delta==0) {
            double x=-b/(2*a);
            System.out.println("denklemn bir kökü vardır : x = "+x);
